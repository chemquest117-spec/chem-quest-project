     ...
     <div class="py-8">
          <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
               <a href="{{ route('admin.admins.show', ['admin' => $admin]) }}"
                    ...
                    <x-icon name="arrow-right" class="w-4 h-4 rotate-180" /> Back to Admin</a>
               <h1 class="text-3xl font-bold text-white mt-1 mb-8">Edit Admin</h1>
               ...
               <div class="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 p-6">
                    <form action="{{ route('admin.admins.update', ['admin' => $admin]) }}" method="POST">
                         ...
                         <div class="mt-8 flex gap-4">
                              ...
                              <a href="{{ route('admin.admins.show', ['admin' => $admin]) }}" class="bg-gray-600 hover:bg-gray-700 text-white px-6 py-3 rounded-lg font-medium transition">
                                   Cancel
                              </a>
                         </div>
                    </form>
