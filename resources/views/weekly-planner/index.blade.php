    ...
    <div class="py-6 sm:py-8" x-data="weeklyPlanner()"
        ...
        <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
            ...
            <div class="mt-3 flex flex-wrap items-center gap-3 sm:gap-4 text-[10px] sm:text-xs text-slate-500">
                ...
                <span>{{ __('planner.click_to_add_task') }}</span>
            </div>
            ...
            <div x-show="addModalOpen" x-transition:enter="transition ease-out duration-300"
                ...
                <form method="POST" action="{{ route('weekly-planner.store') }}">
                    ...
                    <div class="p-5 space-y-5">
                        ...
                        <div>
                            <label
                                class="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2">{{ __('planner.type') }}</label>
                        ...
                        <div>
                            <label
                                class="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2">{{ __('planner.day') }}</label>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div>
                                <label
                                    class="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2">{{ __('planner.time_from') }}</label>
                        ...
                        <div>
                            <label
                                class="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2">{{ __('planner.color') }}</label>
                ...
                <template x-if="selectedEvent">
                    <div>
                            ...
                            <div class="flex flex-wrap items-center gap-3 mt-3 text-xs text-slate-400">
                                ...
                                <span class="flex items-center gap-1" x-show="selectedEvent.completed">
                                    <x-icon name="check-circle" class="w-3.5 h-3.5 text-emerald-400" /> <span
                                        class="text-emerald-400">{{ __('planner.completed') }}</span>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="px-5 py-4" x-show="selectedEvent.notes">
                            <p class="text-xs font-bold text-slate-500 uppercase tracking-wider mb-1.5">{{ __('planner.notes') }}</p>
                        ...
                        <div class="p-5 space-y-2.5 border-t border-white/10">
                            ...
                            <form method="POST" :action="'/weekly-planner/events/' + selectedEvent.id"
                                ...
                                <button type="submit"
                                    ...
                                    <x-icon name="trash" class="w-4 h-4" /> {{ __('planner.remove_task') }}
                                </button>
                            </form>
                        </div>
                    </div>
