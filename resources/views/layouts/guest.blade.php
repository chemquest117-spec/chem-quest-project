...
<head>
    ...
    <title>{{ config('app.name', 'ChemTrack') }}</title>
    <!-- Favicon -->
...
<body class="font-sans antialiased bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white">
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
        ...
        <div
            class="w-full sm:max-w-md mt-6 px-8 py-8 bg-white/5 backdrop-blur-md shadow-2xl border border-white/10 overflow-hidden sm:rounded-3xl">
            {{ $slot }}
        </div>
