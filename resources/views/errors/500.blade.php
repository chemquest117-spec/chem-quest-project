<x-guest-layout :metaTitle="__('errors.server_error')">
     <div class="text-center">
          ...
          <h1 class="text-3xl font-extrabold text-white mb-3 tracking-tight">{{ __('errors.server_error') }}</h1>
          <p class="text-slate-400 mb-10 leading-relaxed text-lg">{{ __('errors.server_error_desc') }}</p>
          <a href="{{ url('/') }}"
