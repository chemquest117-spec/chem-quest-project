...
return [
    ...
    'step' => 'الخطوة :number',
    'step_dates' => 'اختر التواريخ',
    'step_days' => 'أيام الدراسة',
    'step_hours' => 'ساعات في اليوم',
    'step_pace' => 'وتيرة الدراسة',
    'step_confirm' => 'مراجعة وتأكيد',
    'start_date' => 'تاريخ البدء',
    'exam_date' => 'تاريخ الامتحان',
    'preferred_days' => 'أيام الدراسة المفضلة',
    ...
    'nothing_today' => 'لا مهام مجدولة اليوم. استمتع باستراحتك!',
    'missed_tasks' => 'مهام فائتة',
    'missed_warning' => ':count مهمة فائتة. أعد الجدولة للبقاء على المسار.',
    'weekly_view' => 'العرض الأسبوعي',
    'week' => 'الأسبوع :number',
    'days_remaining' => ':days يوم حتى الامتحان',
    ...
    'item_completed' => 'أحسنت! تم تحديد المهمة كمكتملة. ✅',
    'item_unmarked' => 'تم تحديد المهمة كغير مكتملة.',
    'rescheduled' => 'تمت إعادة جدولة :count مهمة بنجاح.',
    ...
    // Weekly Planner
    'weekly_planner_title' => 'خطة الدراسة الأسبوعية',
    'weekly_planner_desc' => 'خطط أيام الدراسة والاختبار لكل مرحلة يدوياً.',
    'stage_week' => 'المرحلة / الأسبوع',
    'stage_completed' => 'تم إنجاز المرحلة',
    'week_label' => 'الأسبوع',
    'study' => 'دراسة',
    'test' => 'اختبار',
    'assign_day' => 'تعيين يوم',
    'assign_day_subtitle' => 'ماذا تريد أن تجدول في هذا اليوم؟',
    'assign_study_slot' => 'تعيين وقت للدراسة',
    'assign_test_slot' => 'تعيين وقت للاختبار',
    'clear_study' => 'مسح الدراسة',
    'clear_test' => 'مسح الاختبار',
    'planned' => 'مجدول',
    'done' => 'تم',
    'passed' => 'ناجح',
    'not_scheduled' => 'غير مجدول',
    'study_session' => 'جلسة دراسة',
    'stage_quiz' => 'اختبار المرحلة',
    'mastered_msg' => 'لقد أتقنت مخرجات التعلم لهذا الأسبوع.',
    'no_plan_initialized' => 'لم يتم إعداد خطة لهذا الأسبوع.',
    'go_to_planner' => 'اذهب إلى المخطط الأسبوعي',
    'not_set' => 'غير محدد',
    'days' => [
        'sat' => 'السبت',
        'sun' => 'الأحد',
    ...
    'stages_to_cover' => ':count مراحل لتغطيها',
    'total_est_time' => 'إجمالي الوقت المقدر ~:time دقيقة',
